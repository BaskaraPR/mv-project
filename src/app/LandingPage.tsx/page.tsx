    ...
    <div className="min-h-screen bg-purple-50">
      <header className="container mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <Image src="/placeholder.svg?height=40&width=40" alt="TaskNest Logo" width={40} height={40} className="rounded-full bg-purple-600" />
      ...
      <main className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="md:w-1/2">
            <Image src="/placeholder.svg?height=400&width=400" alt="Illustration" width={400} height={400} />
          </div>
        </div>
