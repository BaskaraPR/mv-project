...
export default function Profile({ params }: { params: { id: string } }) {
	...
	if (!data) return <p>User data not found</p>;
		...
		<div className="min-h-screen bg-white p-4">
			<div className="mx-auto max-w-xl bg-white rounded-lg shadow">
				...
				<div className="p-6 space-y-6">
					...
					<div className="flex items-center justify-between">
						...
						<div
							className="w-12 h-12 rounded-full flex items-center justify-center cursor-pointer overflow-hidden mb-4"
			...
			{isImageModalOpen && (
				<ImageModal
					...
					userId={params.id}
					onUpdate={refetch}
					updatePicture={data.profile_picture}
				/>
			)}
		</div>
	);
